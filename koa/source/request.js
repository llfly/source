...
module.exports = {
  ...
  get host() {
    const proxy = this.app.proxy;         //获得代理host
    let host = proxy && this.get('X-Forwarded-Host');       //获得请求IP
  ...
  get idempotent() {
    const methods = ['GET', 'HEAD', 'PUT', 'DELETE', 'OPTIONS', 'TRACE'];         //幂等请求,除了POST都是
